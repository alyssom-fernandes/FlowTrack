...
import { AfnBrand } from '../components/ui/AfnBrand'
...
export function Login() {
  ...
  const handleDemo = async () => {
    ...
    try {
      ...
      setError('Modo demo temporariamente indisponível.')
    } finally {
      ...
      <div style={{ width: '100%', maxWidth: '22rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <img
            src="/logo.png"
            alt="FlowTrack"
            style={{ height: '1.75rem', width: 'auto', margin: '0 auto 0.5rem' }}
          />
        ...
        <div style={{
          ...
          {/* AFN Brand — inside card, separated by divider */}
          <div style={{
            paddingTop: '0.75rem',
